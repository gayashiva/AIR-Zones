    ...
    with fiona.open(original_shapefile, 'r') as src:
        ...
        with fiona.open(reduced_shapefile, 'w', **meta) as dst:
            ...
            for i, feature in enumerate(src):
                ...
                if feature['properties']['Temp_min'] <= 0:
...
original_shapefile = 'data/GloRiC_v10_shapefile/GloRiC_v10_shapefile/GloRiC_v10.shp'
reduced_shapefile = 'data/GloRiC_v10_shapefile/reduced_GloRiC_v10.shp'
